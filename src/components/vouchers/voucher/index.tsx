...
import VoucherTableContent from "../component/table"
import { useState } from "react"
import SortByMenu from "../component/sort_by"
import TypeSelectMenu from "../component/type_select copy"
import { dummyVoucherTable } from "../dummy/dummy_voucher_table"


export default function VoucherPageList() {
    const dummyData: { id: string, user_id: string, voucher_type: number, status: number, redeem: Date | undefined, updated: Date, created: Date }[] = dummyVoucherTable;
    ...
    return (
        <div className="w-full h-full flex flex-col items-start justify-start gap-y-4 bg-white shadow-md rounded-md p-8 px-10 overflow-hidden h-full">
            <div className="flex flex-col gap-y-4 w-full h-full">
                ...
                <VoucherTableContent data={dummyData} />
